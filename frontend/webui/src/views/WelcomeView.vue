  ...
  <div class="h-screen w-screen bg-gray-100 dark:bg-gray-900 flex flex-col items-center justify-center p-6 relative">
    ...
    <footer class="absolute bottom-4 w-full flex flex-col items-center gap-2 text-xs text-gray-500 dark:text-gray-400">
        ...
        <div class="flex items-center gap-1">
            <span>Powered by <a href="https://github.com/Grumpified-OGGVCT/lollms" target="_blank" class="font-semibold hover:underline">LoLLMs</a> v{{ appVersion }} by <a href="https://github.com/Grumpified-OGGVCT" target="_blank" class="font-semibold hover:underline">Grumpified-OGGVCT</a></span>
        </div>
    </footer>
  </div>
</template>
